package controller.data.sort.impl;
...
public class TimSortImpl<T> implements TimSort<T> {
     ...
     */
    public <T> List<T> sort(List<T> immutableList, Comparator<? super T> comparator) {
